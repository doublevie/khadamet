...
<link rel="stylesheet" href="libs/main/css/main.css">
  ...
  <body>
    ...
    <nav class="navbar  navbar-dark nav-top fixed-top">
      <a class="navbar-brand" href="#">Khadamet</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link " href="#">Inscreption</a>
          </li>
        </ul>
        <form class="form-inline my-2 my-lg-0">
          <input class="form-control mr-sm-2" type="text" placeholder="Recherche" aria-label="Search">
          <button class="btn btn-warning my-2 my-sm-0" type="submit">Recherche</button>
        </form>
      </div>
    </nav>
